...
const CardIndicatorValue: React.FC<CardIndicatorValueProps> = ({ currentData }) => {
            ...
            <Row gutter={[24, 24]} justify="center">
              ...
              <Col md={12} sm={12} xs={24} style={{ textAlign: 'center' }}>
                <Statistic
                  ...
                  precision={1}
                  valueStyle={{
                    color: currentData?.dailyOrdersRate?.isUp ? '#3f8600' : '#cf1322',
                    fontSize: '20px',
                  }}
                  prefix={
                    currentData?.dailyOrdersRate?.isUp ? <ArrowUpOutlined /> : <ArrowDownOutlined />
                  }
                  suffix="%"
                />
              </Col>
            ...
            <Row gutter={[24, 24]} style={{ marginTop: 24 }} justify="center">
              ...
              <Col md={12} sm={12} xs={24} style={{ textAlign: 'center' }}>
                <Statistic
                  ...
                  precision={1}
                  valueStyle={{
                    color: currentData?.monthlyOrdersRate?.isUp ? '#3f8600' : '#cf1322',
                    fontSize: '20px',
                  }}
                  prefix={
                    currentData?.monthlyOrdersRate?.isUp ? (
                      <ArrowUpOutlined />
                    ) : (
                      <ArrowDownOutlined />
                    )
            ...
            <Row gutter={[24, 24]} justify="center">
              ...
              <Col md={12} sm={12} xs={24} style={{ textAlign: 'center' }}>
                <Statistic
                  ...
                  prefix={
                    currentData?.dailyUnsubscribeRate?.isUp ? (
                      <ArrowUpOutlined />
                    ) : (
                      <ArrowDownOutlined />
                    )
            ...
            <Row gutter={[24, 24]} style={{ marginTop: 24 }} justify="center">
              ...
              <Col md={12} sm={12} xs={24} style={{ textAlign: 'center' }}>
                <Statistic
                  ...
                  precision={1}
                  valueStyle={{
                    color: currentData?.monthlyUnsubscribeRate?.isUp ? '#cf1322' : '#3f8600',
                    fontSize: '20px',
                  }}
                  prefix={
                    currentData?.monthlyUnsubscribeRate?.isUp ? (
                      <ArrowUpOutlined />
                    ) : (
                      <ArrowDownOutlined />
                    )
